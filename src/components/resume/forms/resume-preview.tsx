      ...
      <CardContent>
        <div className="max-w-4xl mx-auto bg-white p-8 shadow-lg rounded-lg border">
          ...
          {formData.education && formData.education.length > 0 && (
            <div className="mb-8">
              <h2 className="text-2xl font-bold text-gray-900 mb-4 border-b-2 border-gray-200 pb-1">Education</h2>
          ...
          {formData.experiences && formData.experiences.length > 0 && (
            <div className="mb-8">
              <h2 className="text-2xl font-bold text-gray-900 mb-4 border-b-2 border-gray-200 pb-1">Work Experience</h2>
          ...
          {formData.skills && formData.skills.length > 0 && (
            <div className="mb-8">
              <h2 className="text-2xl font-bold text-gray-900 mb-4 border-b-2 border-gray-200 pb-1">Skills</h2>
          ...
          {formData.projects && formData.projects.length > 0 && (
            <div className="mb-8">
              <h2 className="text-2xl font-bold text-gray-900 mb-4 border-b-2 border-gray-200 pb-1">Projects</h2>
              <div className="space-y-6">
          ...
          {formData.certifications && formData.certifications.length > 0 && (
            <div className="mb-8">
              <h2 className="text-2xl font-bold text-gray-900 mb-4 border-b-2 border-gray-200 pb-1">Certifications</h2>
              <div className="space-y-4">
          ...
          {(!formData.experiences || formData.experiences.length === 0) &&
            ...
            (!formData.certifications || formData.certifications.length === 0) && (
              <div className="text-center py-8 text-gray-500">
                <p className="text-lg mb-2">Additional sections will appear here when you add content.</p>
                <p className="text-sm">Your resume currently includes Personal Information and Education sections.</p>
              </div>
            )}
        </div>
      </CardContent>
