            ...
            <div className="flex flex-col justify-center space-y-4">
              <div className="space-y-2">
                ...
                <p className="max-w-[600px] text-muted-foreground md:text-xl">
                  Our resume builder helps you create a professional resume that showcases your
                  skills and experience. Choose from multiple templates and customize to your needs.
                </p>
              </div>
          ...
          <div className="mx-auto grid max-w-5xl items-center gap-6 py-12 lg:grid-cols-3">
            <div className="flex flex-col items-center space-y-4 rounded-lg border p-6">
              ...
              <p className="text-center text-muted-foreground">
                Enter your personal information, education, work experience, and skills.
              </p>
            </div>
            <div className="flex flex-col items-center space-y-4 rounded-lg border p-6">
              <div className="flex h-16 w-16 items-center justify-center rounded-full bg-primary text-primary-foreground">
